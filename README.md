...
Latest release **0.5.0** (2026-09-13) · **12** changes in development · [full changelog](CHANGELOG.md) (kept in Chinese)

<details open>
<summary><b>2026-09-13</b> · Unreleased · 3 added · 7 style · 2 fixed</summary>
...
- 应用内更新在连不上 GitHub 时改从 quota.bar 服务器检查和下载，打不开 GitHub 的网络也能收到更新；下载到的安装包照旧要验证开发者签名和 Apple 公证才会安装。
